...
class Config:
    ...
    OBJECT_WEB_ACCESS_KEY: str = os.getenv(
        "OBJECT_WEB_ACCESS_KEY", "bHRhU4yBlvx1VkEVhdIC"
    )
    OBJECT_WEB_SECRET_KEY: str = os.getenv(
    ...
    # 檔案大小限制 (bytes)
    DEFAULT_FILE_SIZE_LIMIT: int = int(
        os.getenv("DEFAULT_FILE_SIZE_LIMIT", str(1 * 1024 * 1024))
    )  # 1MB
    SMALL_FILE_SIZE_LIMIT: int = int(
        os.getenv("SMALL_FILE_SIZE_LIMIT", str(100 * 1024))
    )  # 100KB
    MEDIUM_FILE_SIZE_LIMIT: int = int(
        os.getenv("MEDIUM_FILE_SIZE_LIMIT", str(550 * 1024))
    )  # 550KB
    LARGE_FILE_SIZE_LIMIT: int = int(
        os.getenv("LARGE_FILE_SIZE_LIMIT", str(800 * 1024))
    )  # 800KB
