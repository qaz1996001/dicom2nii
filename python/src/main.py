...
def run_dicom_rename_mr(executor: ProcessPoolExecutor, input_path, output_path):
...
def run_convert_nifti(executor: ProcessPoolExecutor, input_path, output_path):
...
if __name__ == "__main__":
    ...
    if input_dicom_path and output_dicom_path:
        ...
        run_dicom_rename_mr(
            executor=dicom_rename_executor,
