...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dicom', dest='input_dicom', type=str, required=True,
                        help="input the raw dicom folder.\r\n")
    parser.add_argument('--output_dicom', dest='output_dicom', type=str, required=True,
                        help="output the rename dicom folder.\r\n")
    parser.add_argument('--output_nifti', dest='output_nifti', type=str, required=True,
